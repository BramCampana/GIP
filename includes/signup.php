...
$sql = "SELECT * FROM `registration` WHERE `firstname` = '$firstname' AND `lastname`='$lastname'";
...
if ($resultCheck > 0) {
  ...
  $sql = "INSERT INTO `registration`(`firstname`, `lastname`, `email`, `tel`, `password`, `function`)
  VALUES ('$firstname', '$lastname','$mail', '$telnr','$password','$function')";
